...
public class Kho {
    protected String MaKho, TenKho, DienThoai, Diachi;
    public Kho(){}
    ...
    public void nhap(){
        ...
        TenKho= sc.nextLine();
        System.out.println("Nhap so dien thoai kho: ");
        DienThoai= sc.nextLine();
        System.out.println("Nhap dia chi kho: ");
        Diachi= sc.nextLine();
    }
    public void xuat(){
        System.out.println("Ma kho: "+MaKho+"; ten kho: "
        +TenKho+"; So dien thoai: "+DienThoai+"; Dia chi: "+Diachi);
    }
}